...
# =============================================================================
# SCHEMA REGISTRY
# Maps test names to their expected schemas
# =============================================================================

SCHEMA_REGISTRY = {
    "extraction": ExtractionResult,
    "extraction_empty": EmptyExtractionResult,
    "consolidation_ideas": ConsolidatedIdea,  # Note: response is list of these
    "consolidation_problems": ConsolidatedProblem,
    "consolidation_workflows": ConsolidatedWorkflow,
    "categorization": ScoredIdea,  # Note: response is list of these
    "synthesis_profile": PassionProfile,
    "synthesis_intersection": IntersectionIdea,  # Note: response is list of these
    "synthesis_solution": SolutionIdea,  # Note: response is list of these
    "synthesis_profile_based": ProfileBasedIdea,  # Note: response is list of these
}
